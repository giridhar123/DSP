...
function showGuestMenu() {
	$(".navbar-right").append('<li><a href="#" onClick="onLoginTopButtonClicked();"><span class="glyphicon glyphicon-log-in"></span> Area Riservata</a></li>')
		.append('<li><a href="signUp.html"><span class="glyphicon glyphicon-log-in"></span> Apri il tuo conto</a></li>');
}
...
function showUserMenu() {
	$(".navbar-right").append('<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">'+localStorage.getItem("nome")+'<span class="caret"></span></a>'+
									'<ul class="dropdown-menu">'+
										'<li><a href="manageAccount.html">Gestisci Account</a></li>'+
										'<li><a href="recharge.html">Ricarica conto</a></li>'+
										'<li><a href="manageMethods.html">Metodi di Pagamento</a></li>'+
										'<li><a href="managePeriodic.html">Gestisci rateizzazioni</a></li>'+
										'<li><a href="requestPage.html">Gestione richieste</a></li>'+
