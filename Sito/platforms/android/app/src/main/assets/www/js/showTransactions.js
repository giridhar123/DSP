        ...
        if (message.command == '41'){
            if (message.resultQuery == 0) {
                $("#myContent").append('<div align="center">Nessun movimento effettuato</div>'+
                    '<a href="index.html"><button class="cancelButton"><div class="buttonText">Indietro</div></button></a>');
            }
            else {
                /*
                ADDEBITI
                            ...
                            websocket.onmessage = function (event) {
                                ...
                                websocket.onmessage = function (event) {
                                    ...
                                    websocket.onmessage = function (event) {
                                        ...
                                        $("#myContent").append('<a href="index.html"><button class="cancelButton"><div class="buttonText">Indietro</div></button></a>');
                                    }
                                }
                            }
                        }
