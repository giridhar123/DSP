...
function showGuestMenu() {
	$(".navbar-right").append('<li><a href="#" onClick="onLoginTopButtonClicked();"><span class="glyphicon glyphicon-log-in"></span> Area Riservata</a></li>')
		.append('<li><a href="http://www.dsp.it:8000/signUp.html"><span class="glyphicon glyphicon-log-in"></span> Apri il tuo conto</a></li>');
}
...
function showUserMenu() {
	$(".navbar-right").append('<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">'+localStorage.getItem("nome")+'<span class="caret"></span></a>'+
									'<ul class="dropdown-menu">'+
										'<li><a href="http://www.dsp.it:8000/user/manageAccount.html">Gestisci Account</a></li>'+
										'<li><a href="http://www.dsp.it:8000/user/recharge.html">Ricarica conto</a></li>'+
										'<li><a href="http://www.dsp.it:8000/user/manageMethods.html">Metodi di Pagamento</a></li>'+
										'<li><a href="http://www.dsp.it:8000/user/managePeriodic.html">Gestisci rateizzazioni</a></li>'+
										'<li><a href="http://www.dsp.it:8000/user/requestPage.html">Gestione richieste</a></li>'+
...
function onLoginButtonClicked() {
    ...
    websocket.onmessage = function (event) {
    	...
    	if (message.command == '1')
    	{
    		...
    		location.href = "http://www.dsp.it:8000/index.html","_self";
    	}
